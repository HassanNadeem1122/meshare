...
> `meshare site ./examples/bounce-demo` prints a link + QR instantly, then a fresh browser downloads it peer-to-peer (hash-verified) and opens the game **full-screen, nothing installed**.
...
1. `npx meshare ./file` gives you a link + QR, and a seeder tab opens.
